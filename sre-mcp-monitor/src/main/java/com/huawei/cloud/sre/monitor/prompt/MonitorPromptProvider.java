package com.huawei.cloud.sre.monitor.prompt;
...
/**
 * Monitor MCP Prompt 注册提供者。
 *
 * <p>从 {@code resources/prompts/*.yaml} 加载所有 Prompt 模板，注册为 MCP Prompt。
 * 支持 4 个 Prompt：anomaly-analysis、capacity-planning、alert-triage、baseline-review。
 */
@Component
public class MonitorPromptProvider {

    private static final Logger log = LoggerFactory.getLogger(MonitorPromptProvider.class);
