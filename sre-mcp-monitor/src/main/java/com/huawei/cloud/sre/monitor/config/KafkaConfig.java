...
/**
 * Kafka 配置：生产者、消费者、监听器容器（手动 Ack 模式）。
 *
...
public class KafkaConfig {
    ...
    @Value("${spring.kafka.consumer.group-id:sre-monitor-group}")
    private String groupId;

    /**
     * Kafka 生产者工厂（String key/value）。
     *
    ...
    /**
     * KafkaTemplate（供 MonitorEventProducer 注入）。
     *
    ...
    /**
     * Monitor 专用监听器容器工厂（手动 Ack，支持虚拟线程）。
     *
