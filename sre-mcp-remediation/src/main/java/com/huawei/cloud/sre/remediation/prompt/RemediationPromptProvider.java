package com.huawei.cloud.sre.remediation.prompt;
...
/**
 * Remediation MCP Prompt 注册提供者。
 *
 * <p>从 {@code resources/prompts/*.yaml} 加载所有 Prompt 模板，注册为 MCP Prompt。
 * 支持 4 个 Prompt：risk-assessment、approval-request、remediation-plan、post-remediation-review。
 */
@Component
public class RemediationPromptProvider {

    private static final Logger log = LoggerFactory.getLogger(RemediationPromptProvider.class);
